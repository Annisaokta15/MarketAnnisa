  ...
  <body id="header">
    ...
    <section class="py-5">
      <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="col-md-6"><img class="rounded card-img-top mb-5 mb-md-0" src="storage/{{ $item->foto }}" alt="..." /></div>
          <div class="col-md-6">
            <div class="small mb-1 text-white">SKU: BST-498</div>
            <h1 class="display-5 fw-bolder text-white">{{ $item->nama_menu }}</h1>
            <div class="fs-5 mb-5">
              {{-- <span class="text-decoration-line-through text-white">Rp.27.000</span> --}}
              <span class="text-white">{{$item->harga_menu}}</span>
            </div>
    ...
    <footer id="body" class="py-5">
      <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Saiko Resto 2023</p></div>
    </footer>
  </body>
</html>
